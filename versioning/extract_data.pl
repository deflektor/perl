...
#globla settings
$dsn="DBI:Oracle:EDWP06";
$username="admin";
$auth="xxxxxxxx";

$start_path = "C:/ST/DI/5-Delivery/L3.0.0-DI/503-Tables-Views-Procedures";
#global vars
my @working_array;
my $dbh;
my $last_object_type;
...
sub my_connect()
{
	...
	my $merge_handle = $dbh->prepare("
			...
			--and owner in ('ADMIN', 'STG', 'EDW', 'CTRL', 'MASTER_DATA')
			and object_name not like 'X_%'
			and object_name not like 'SYS_%'
			--and object_type='PACKAGE BODY' and owner ='ADMIN'
            and owner ='EDW'
			and status = 'VALID'
